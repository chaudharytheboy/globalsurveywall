...
//print_r($data);exit;
?>
<div class="col" style='text-align:center;background-color:#232f3e;color:#fff;padding:2px;margin-top:1rem;font-family:roboto'>
      ...
      <form method="POST" action="" enctype = 'multipart/form-data' id="submitData">
        ...
        <div class="form-group">
                    <label for="exampleInputPassword1">Most Popular / Top Rated / Best Offer Image Uploaded
                        For</label><br />
                    <img src="../<?php echo $data['img_popular'];?>" width="100px;" id = "walmartpops">
                    <input type="file" name="img_popular" onchange = Walmartpopsimg(this);>
        </div>
