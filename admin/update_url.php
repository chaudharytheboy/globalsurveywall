...
if(isset($_POST['idfrom'])  && isset($_POST['idTo']))
{
  ...
  $update = mysqli_query($conn,"update products set url_1 ='".$_POST['urlfrom']."', product_name = '".$pro_nameFrom."' , images = '".$_POST['proImagefrom']."',
   img_popular = '".$_POST['proImagePopularfrom']."' ,description = '".$pro_descFrom."', product_price = '".$pro_priceFrom."',regular_price = '".$pro_reg_priceFrom."', shipping = '".$pro_shippingFrom."' where id=".$fromIDs[1]);
  ...
  img_popular = '".$_POST['proImagePopularTo']."' ,description = '".$pro_descTo."',product_price = '".$pro_priceTo."', regular_price = '".$pro_reg_priceTo."', shipping = '".$pro_shippingTo."' where id=".$roIDs[1]);
  $response = array('status'=>TRUE);
  echo json_encode($response);
}
