...
<div class="container-fluid">
  <div class="row">
  <div class="col" style='text-align:center;background-color:#232f3e;color:#fff;margin-top:1rem;letter-spacing:1px;padding:2px'> 
        <a href="logout.php" class="btn " style="float:right;margin-top:10px;margin-right:1rem;background-color:#fff;color:#333;font-family:roboto">Logout</a>
...
<div class='container-fluid' style="margin:1rem 2rem">
    <div class="row">
        ...
        <table class="table table-hover table-bordered" style="margin:2rem 0;table-layout: fixed;
