...
$(document).on('click', '.swap', function() {
    ...
    $.ajax({
        url: baseUrl + "/globalsurveywall/admin/update_url.php",
        type: "post",
        data: postDat,
        dataType: "json",
...
$(document).on('click','.removePic',function(){
    ...
    $.ajax({
        ...
        success: function(jsonResponse) {
            if (jsonResponse.status == true) {   
                $(Obj).parent().parent('tr').find('.images').find('img').attr('src',baseUrl + '/globalsurveywall/images/products_image/default-product-img.jpg');                 
...
$(document).on('click', '.remove_pic',function(){
    ...
    var Obj = $(this);
       $.ajax({
        ...
        success: function(jsonResponse) {
            if (jsonResponse.status == true) {   
                $(Obj).parent().parent('tr').find('.img_popular').find('img').attr('src',baseUrl + '/globalsurveywall/images/popular_image/default-product-img.jpg');                 
                $(Obj).parent().find('a').remove();
            }
        },
        error: function(jsonResponse) {
